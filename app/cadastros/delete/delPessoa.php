  ...
  <main>
    ...
    <div class="row g-5">     
      <div class="col-md-7 col-lg-8">
        ...
        <form action="delPessoabd.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate> 
          <div class="row g-3">
          ...
          <div class="d-grid gap-2 d-md-block">
            <button class="btn btn-primary col-sm-4" type="submit">Excluir</button>
