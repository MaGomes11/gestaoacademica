    ...
    <table class="table table-hover table-light">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a class="fas fa-edit fa-lg text-info" href="../update/atuEspecializacao.php?id=<?=$linha['Espc_i_cod'];?>"></a></td>
          <td><a class="fas fa-trash-alt fa-lg text-danger" href="exc_login.php?id=<?=$linha['Espc_i_cod'];?>"></a></td>
        </tr>
        <?php
          }
        ?>
