...
<div class="container-sm">
  <main>
    ...
    <ul class="nav justify-content-end">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="../insert/CadDisciplina.php">Cadastrar</a>
      </li>
      <li class="nav-item">
    ...
    <?php 
      require_once("ViewDisciplinabd.php");
      if($total > 0){
    ?>
    <table class="table table-hover table-light">
      <thead class="table table-hover table-secondary">
        <tr>
          <th scope="col">#</th>
          <th scope="col">Descrição de Disciplina</th>
          <th width="60">ATU</th>
          <th width="60">EXC</th>
        </tr>
      </thead>
